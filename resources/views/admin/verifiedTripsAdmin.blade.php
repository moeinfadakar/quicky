...
<head>
    ...
    <title>ACCEPTED TRIPS</title>
</head>
<body>
    <div class="container-fluid">
      <h2 class=" text-center">ACCEPTED TRIPS</h2>
        <div class="row">
            <div class="col-3">
            ...
            <div class="col-9">
                ...
                <table class="table">
                    ...
                    <tbody>
                         @foreach ($allVerifiedTrips as $Trip )
                                  <tr>
                        <th>{{ $Trip->id }}</th>
                        <td>{{ $Trip->driver->full_name }}</td>
                        <td>{{  $Trip->user->full_name }} </td>
                        <td>{{ $Trip->price }}</td>
                        <td><a href="{{ url("/EditVerifiedTrip/".$trip->id) }}" class=" btn btn-warning">Edit</a></td>
                        <td><a href="{{ url("/deleteVerifiedTrip/".$trip->id) }}" class=" btn btn-danger">Delete</a></td>
                      </tr>
